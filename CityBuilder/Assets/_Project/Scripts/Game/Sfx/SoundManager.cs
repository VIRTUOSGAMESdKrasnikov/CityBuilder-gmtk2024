...
namespace CityBuilder.Game.Sfx
{
    public class SoundManager : MonoBehaviour
    {
        ...
        private EventBinding<ErrorClickedEvent> _errorClickedEvent;
        ...
        public void Init()
        {
            ...
            var errorClickedEventBuilder = new EventBinding<ErrorClickedEvent>.Builder();
            ...
            _errorClickedEvent = errorClickedEventBuilder.WithAction(PlayErrorClickEvent).Build();
            ...
            EventBus<ErrorClickedEvent>.Subscribe(_errorClickedEvent);
        ...
        private void PlayErrorClickEvent(ErrorClickedEvent obj)
        {
            var availableSlot = GetAvailableSlot();
            availableSlot.clip = _runtimeDataProvider.UiSoundsStorage.ErrorSounds.Random();
